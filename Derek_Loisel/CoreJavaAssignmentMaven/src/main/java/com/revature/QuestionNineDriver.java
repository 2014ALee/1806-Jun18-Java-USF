...
public class QuestionNineDriver {
	...
	public static void main(String[] args) {
		...
		// run the getPrimes method on the ArrayList to get a list of primes
		ArrayList<Integer> primesList = getPrimes(numsArrayList);

		//pring the list of primes
