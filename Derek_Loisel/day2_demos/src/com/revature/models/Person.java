...
public class Person {
	...
	@Override // overrides to string to list actual variable values instead of reference location
	...
	//hashcode and equals override together to change the .equals to compare object values
	@Override
	public int hashCode() {
		final int prime = 31;
		int result = 1;
