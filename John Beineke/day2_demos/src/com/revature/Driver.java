...
public class Driver {
	...
	public static void main(String[] args) {
		...
		//person1.firstName;
		// private fields are not visible outside of their class declaration
		...
		System.out.println(person1 == person3); //false because different memory location
		System.out.println(person1.equals(person3)); 
		// true because we invoked equals method from Object() class
		// goes through and compares field by field 
