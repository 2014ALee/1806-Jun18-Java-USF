...
public class Student {
	...
	@Id // designates this field as mapping to a PK of the table
	@Column(name="id") // maps the field to a specified column name
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="stu_seq") // chooses a generation strategy and generator to create new PKs
	private int id;
