...
public class ERSService {
	...
	public User loginUser(String username, String password) {
		System.out.println("[LOG] - In ERSService.loginUser()");
		User user = null;
		User nameMatch = userDao.getUserByUsername(username.toLowerCase());
		
		if(nameMatch != null) {
			String pwHash = hashPassword(password, nameMatch.getPwSalt());
			
			if(pwHash.equals(nameMatch.getPwHash())) {
				user = nameMatch;
			} else {
