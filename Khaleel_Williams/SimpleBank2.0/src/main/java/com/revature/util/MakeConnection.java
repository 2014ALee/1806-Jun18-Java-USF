...
public class MakeConnection {
	...
	public Connection createConnection() {
		...
		try {
			prop.load(new FileReader("C:\\Users\\Cry\\project-repos\\1806-Jun18-Java-USF\\Khaleel_Williams\\"//FILENOTFOUND EXCEPTION
					+ "SimpleBank2.0\\src\\main\\resources\\application.properties"));
