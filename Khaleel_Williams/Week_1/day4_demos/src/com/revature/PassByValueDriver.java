...
public class PassByValueDriver {
	...
	public static void main(String[] args) {
		 ...
		 * 
		 * In Java, when we pass a variable of a primitive data type into a method = a
		 * copy of the variable is made and manipulated within the method. This means that changes
