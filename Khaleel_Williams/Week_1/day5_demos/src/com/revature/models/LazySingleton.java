...
public class LazySingleton {
	 ...
	 * instance are persisted across all references (since they refer to the same
	 * object)
	 */
	...
	/*
	 * A static member of type LazySingleton will hold our one and only instanc. It starts off 
	 * as uninstantiated since we want to load it only when it is required (lazy-loading)
	 */
	...
	/*
	 * We need to override the clone()	method (inherited from Object) so that if itt is invoked
