...
public class Charlie extends Beta{
	...
	//	}
	/*
	 * This is valid, because we are overriding the method by throwing a more
	...
	/*
	 * This is invalid, because we are trying to override teh inherited method by broadening
	 * the exception thrown.
	 */
	// Cannot make it more generic, therefore same or lower. Cannot add a throws clause, but can take it away.
