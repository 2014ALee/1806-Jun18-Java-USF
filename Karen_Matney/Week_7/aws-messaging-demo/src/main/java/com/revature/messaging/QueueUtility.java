...
public class QueueUtility {
	private BasicAWSCredentials awsCredentials = new BasicAWSCredentials(System.getenv("MESSAGING_ACCESS_KEY"),System.getenv("MESSAGING_SECRET_ACCESS_KEY"));
	...
	// Ideally we would pads in a parameter to determine which queue to poll from
