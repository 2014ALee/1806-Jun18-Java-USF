...
public class SoapClientDriver {
	...
	public static void main(String[] args) {
		...
		// Create an instance of the LibrarayService using the implementation provided through the SOAP service
		LibraryService library = (LibraryService) factory.create();

		// Test out our service operations
		System.out.println("[DEBUG] - LibarayService.getAllBooks()...");
