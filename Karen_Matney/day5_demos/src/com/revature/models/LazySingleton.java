...
/*
 * The Singleton patter is implemented by creating a class with a method that creates
...
public class LazySingleton {
	/*
	 * This is just here to prove that change to one reference to our LazySingleton
	...
	/*
	 * Making the constructor private snsures that it cannot be called outside of this class.
	 */
	private LazySingleton() { }
	
	public static LazySingleton getInstance() {
		/*
		 * If the static member 'mySingleton is null, instatiate a new LazySingleton object
