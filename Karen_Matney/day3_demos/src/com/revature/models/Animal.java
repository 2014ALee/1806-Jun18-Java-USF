 ...
 * that MUST be overridden by a concrete subclass. Although there are cases where an abstract class has no
...
public abstract class Animal {
	...
	/*
	 * Abstract classes can have concrete methods (methods with implementation). However,
