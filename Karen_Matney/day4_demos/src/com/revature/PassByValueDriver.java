...
public class PassByValueDriver {
	public static void main(String[] args) {
		/*
		 * Passing primitives as paramenters
		 * 
		 * In Java, when we pass a bariable of a primitive data type into a method - a copy of the
		 ...
		 * method to the console using System.out.println() we get a reference location printed to the screen.
		 * 
