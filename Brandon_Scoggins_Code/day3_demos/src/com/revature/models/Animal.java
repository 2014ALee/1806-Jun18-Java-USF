...
/*
 * An abstract is a class cannot be instantiated. Abstract classes often contain unimplemented methods
 * that MUST be overridden by a concrete subclass. Although there are cases where an abstract class has 
 * no unimplemented methods and is declared as abstract simply to prevent direct instantiation.
 */
...
public abstract class Animal {
	...
	/*
	 * Abstract classes can have concrete methods (methods with implementations). However,
