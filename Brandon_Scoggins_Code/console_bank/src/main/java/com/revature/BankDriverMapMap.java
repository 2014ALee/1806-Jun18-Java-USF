...
//
//	static Map<String, Map> userInfoMap = new HashMap<>();
//	static Map<String, String> userDetailsMap = new HashMap<>();
...
//		
//		System.out.println();
//		System.out.println("Current Balance: $" + userInfoMap.get(userName).get(passWord));
//		System.out.println();
//		
//		displayLoggedInMenu();
//	}
...
//		
//		userDetailsMap.put(passWord, balance);
//		userInfoMap.put(userName, userDetailsMap);
//		
//		checkBalance();
//	}
//	
...
//		userInfoMap.put(userName, userDetailsMap);
//
//		System.out.println(userName + " " + userInfoMap.get(userName).) + " " + userInfoMap.get(userName)[1]);
//////////////////////////////////////////////////////
