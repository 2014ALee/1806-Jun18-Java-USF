...
public class NotificationUtility {
	...
	/*
	 * Publishes a message to our SNS topic. Ideally we could have a properties file link topics to their respective ARN, 
	 * and have the topic passed as a parameter here.
	 */
