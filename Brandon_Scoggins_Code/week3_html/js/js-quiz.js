...
window.onload = function() {
    /*
    // Dynamically create HTML elements (ES6)
...
function buildQuiz() {
    ...
    */
    ...
    myQuestions.forEach((currentQuestion, questionNumber) => {
        // storing the list of the answer choices
        const answers = [];
...
function showResults() {
    ...
    myQuestions.forEach((currentQuestion, questionNumber) => {
        ...
        // notes on guard and default will go here
...
// convenient references for out HTML elements
