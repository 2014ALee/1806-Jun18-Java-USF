...
public class Person {
	...
	public String getLastName() {
		int x = 4; //method level scope (can't be seen outside of the code block)'
		System.out.println(lastName);//class level scope, can be seen anywhere in the class
		
		if(true)
		{
			int y = 5; //block level scope, can't be seen outside of the if block
		}
		return lastName;
	}
