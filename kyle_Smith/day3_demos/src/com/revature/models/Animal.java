...
public abstract class Animal {
	...
	/*
	 * Abstract methods are methods that have no implmentation (body). They only consist of a method
	...
	/*
	 * As was mentioned, abstract classes can ahve concrete methods (methods with implementation). However,
