...
public class OperatorDriver {
	...
	public static void main(String[] args) {
		 ...
		 * 
		 * These are similar to the logical operators, and actually give the same results as their counterparts. However,
		 * bitwise operators only check what is necessary to return a value. 
		 * 
